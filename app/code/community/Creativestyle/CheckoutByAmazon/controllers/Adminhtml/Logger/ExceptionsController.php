 ...
 */
class Creativestyle_CheckoutByAmazon_Adminhtml_Logger_ExceptionsController extends Mage_Adminhtml_Controller_Action {

    protected function _getModel() {
        return Mage::getModel('checkoutbyamazon/log_exception');
    }

    protected function _initAction() {
        $this->loadLayout()->_setActiveMenu('creativestyle/checkoutbyamazon/logger/exceptions');
        return $this;
    }
    ...
    protected function _setTitle($title = null) {
        $this->_title(Mage::helper('checkoutbyamazon')->__('Checkout by Amazon'))
            ->_title(Mage::helper('checkoutbyamazon')->__('Amazon exceptions'));
    ...
    public function viewAction() {
        ...
        if ($logModel->getId()) {
            ...
            $this->_addContent($this->getLayout()->createBlock('checkoutbyamazon/adminhtml_logger_exceptions_view')->setLogModel($logModel));
            $this->renderLayout();
        } else {
